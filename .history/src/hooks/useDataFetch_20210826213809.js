...
export const useDataFetch = async(rut) => {
    ...
    const url = `https://multigarantiassoapapi.azurewebsites.net/api/test/getactivities?rut=${ encodeURI( category ) }&limit=10&api_key=A8xMXqzieIHmtO3BjGLAtf1daSSDAv8K`;
