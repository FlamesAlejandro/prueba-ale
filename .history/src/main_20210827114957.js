                    ...
                    <div className="row row-cols-12 text-center">
                        ...
                        <h3>Principales Coberturas</h3>
                            <div class="row row-cols-2">
                                ...
                                <div class="col">Defensa penal del Asegurado</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row row-cols-12 text-center">
                        ...
                        <div className="col">
                            ...
                            <div className="row row-cols-2">
                                <div className="col">Responsabilidad Civil Cruzada</div>
                                <div className="col">Responsabilidad Civil por transporte de personas</div>
                                <div className="col">Responsabilidad Civil Patronal</div>
                                <div className="col">Defensa penal del Asegurado</div>
                            </div>
                        </div>
                    </div>
                </div>
